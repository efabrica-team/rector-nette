...
CODE_SAMPLE
     ...
     */
    private function printTemplateTypeToTemplateFiles(
        array $actionVarTypes,
        string $presenterName,
        string $fullPresenterName
    ): void {
    ...
    private function createTemplateClass(
        ...
        $fullTemplateClassName = '\\' . Strings::replace(
            $fullPresenterName,
            $presenterPattern,
            $upperCasedActionName . 'Template',
        );
        $templateClass = $this->classWithPublicPropertiesFactory->createNode(
            $fullTemplateClassName,
            $properties,
            $this->templateClassParent,
